...
const TracklistSortStyled = withStyles(styles)(({ classes, input, editable, record, source }) =>
{
...
export const TracklistSortInput = addField(props => <TracklistSortStyled {...props} editable={true} />);
